          ...
          <div class="p-6">
            <div class="max-w-3xl mx-auto">
              ...
              <div v-if="feed.type === 'social_media'" class="mb-6 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                <!-- Platform Header -->
                <div class="px-4 py-3 flex items-center space-x-2 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                ...
                <div class="overflow-hidden">
                  ...
                  <div v-if="feed.meta_data?.embed_url" class="w-full aspect-video md:h-[540px]">
                    ...
                    <div v-if="feed.meta_data?.platform === 'tiktok'" class="w-full h-full flex items-center justify-center">
                      <div class="relative mx-auto" style="width: 325px; max-width: 100%; height: 100%;">
                        <!-- Gunakan blockquote native TikTok -->
                        <div 
                        ...
                        <!-- Iframe dengan URL embed versi v2 -->
                        <iframe
